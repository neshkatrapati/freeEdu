...
<body>
	...
	$placeBranch = getBatches('bat[]');
        ...
        echo "<tr><td colspan=2 style='text-align:center;'>Roll Number:&nbsp;<input type='text' name='srno' required=true></td></tr>";
        ...
        echo "<tr><td>Slogin:&nbsp;<input type='text' name='slogin' required=true></td>";
        echo "<td>Spassword:&nbsp;<input type='text' name='spswd' required=true></td>";
    	...
    	if(isset($_POST['submit']))
	   {
		...
		$batyr=$array[1];
                ...
                {  
                    ...
                    mysql_query("insert into MSTUDENTT values('$stot','$srno','$fn $ln','','$sinfo','$num','$batid','$sec','-1','0')");
