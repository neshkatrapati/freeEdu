<html>
	...
	function showUser(branch,reg,search)
	{
	    ...
	    {
		document.getElementById("txtHint").innerHTML="Note : E-Books will be shown here";
		return;
	    }
	    ...
	    xmlhttp.open("GET","../modules/library/viewENext.php?branch="+branch+"&reg="+reg+"&search="+search,true);
	    xmlhttp.send();
	}        
	</script>
    </head>
<body>
    ...
    <center>
        ...
        include_once("../lib/connection.php");  
            ...
            echo "<center>";
            echo "<fieldset>";
            echo "<legend>Available E-Books</legend>";
	    ...
	    echo "</select>&nbsp&nbsp";
            echo "</fieldset>";
            echo "<br><br><br><br><div id='txtHint'>Note :E-Books will be shown here.</div><br>";
            echo "</form>";
            ?>
