...
<body>
    <center>
        ...
        include_once("../lib/connection.php");  
            ...
            if($rorder!=NULL)
            {
                $r_check=mysql_query("select * from MORDERT where orderid='$rorder'");
                $r_check_num=mysql_num_rows($r_check);
                if($r_check_num!=0)
                {
	    ...
	    echo "</select>&nbsp&nbsp";
            echo "</fieldset>";
            echo "<br><br><br><br><div id='txtHint'><center><h6>Note : Books will be shown here</h6></center></div><br>";
            echo "</form>";
            ?>
    </center>
</body>
